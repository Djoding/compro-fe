      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-gray-600">Kelola layanan yang ditawarkan perusahaan</p>
          </div>
        </div>
        <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
          ...
          <DialogContent className="max-w-2xl">
            <DialogHeader>
              ...
              <DialogDescription>
                {editingService ? "Perbarui informasi layanan" : "Tambahkan layanan baru yang ditawarkan"}
              </DialogDescription>
            </DialogHeader>
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                />
                <p className="text-xs text-gray-500">Pisahkan setiap teknologi dengan koma</p>
              </div>
              ...
              <DialogFooter>
                ...
                <Button type="submit" disabled={submitting}>
                  {submitting ? "Menyimpan..." : editingService ? "Perbarui" : "Tambah"}
                </Button>
              </DialogFooter>
            </form>
          </DialogContent>
      ...
      {services.length === 0 && (
        <Card>
          <CardContent className="flex flex-col items-center justify-center py-12">
            ...
            <p className="text-gray-500 text-center mb-4">Mulai tambahkan layanan yang ditawarkan perusahaan</p>
