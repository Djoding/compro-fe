...
export default function TestimonialsPage() {
    ...
    try {
      ...
      const errorMessage =
        error instanceof Error
          ? error.message
          : t("admin.pages.testimonials.errors.genericError") ||
            "Terjadi kesalahan";
      alert(
        t("admin.pages.testimonials.errors.createFailed").replace(
          "{error}",
          errorMessage
        ) || "Gagal membuat testimonial: " + errorMessage
      );
    } finally {
      setSaving(false);
    }
      ...
      const errorMessage =
        error instanceof Error
          ...
          : t("admin.pages.testimonials.errors.genericError") ||
            "Terjadi kesalahan";
      alert(
        t("admin.pages.testimonials.errors.updateFailed").replace(
          "{error}",
          errorMessage
        ) || "Gagal mengupdate testimonial: " + errorMessage
      );
    } finally {
      setSaving(false);
    }
  ...
  const handleDelete = async (id: string, clientName: string) => {
    if (
      window.confirm(
        t("admin.pages.testimonials.deleteConfirm").replace(
          "{clientName}",
          clientName
        ) ||
          `Apakah Anda yakin ingin menghapus testimonial dari "${clientName}"?`
      )
    ) {
      try {
        ...
        const errorMessage =
          error instanceof Error
            ...
            : t("admin.pages.testimonials.errors.genericError") ||
              "Terjadi kesalahan";
        alert(
          t("admin.pages.testimonials.errors.deleteFailed").replace(
            "{error}",
            errorMessage
          ) || "Gagal menghapus testimonial: " + errorMessage
        );
      }
    }
  };
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-gray-900">
            {t("admin.pages.testimonials.title") || "Manajemen Testimoni"}
          </h1>
          <p className="text-gray-600">
            {t("admin.pages.testimonials.subtitle") ||
        ...
        <Dialog open={isCreateOpen} onOpenChange={setIsCreateOpen}>
          <DialogTrigger asChild>
            <Button onClick={resetForm}>
              ...
              {t("admin.pages.testimonials.addTestimonial") ||
                "Tambah Testimoni"}
            </Button>
          </DialogTrigger>
          <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
            <DialogHeader>
              ...
              <DialogDescription>
                {t("admin.pages.testimonials.addDescription") ||
            ...
            <form onSubmit={handleCreate} className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-2">
                  <Label>
                    {t("admin.pages.testimonials.form.clientName") ||
                      "Nama Klien"}{" "}
                    *
                  </Label>
                  <Input
                ...
                <div className="space-y-2">
                  <Label>
                    {t("admin.pages.testimonials.form.company") || "Perusahaan"}{" "}
                    *
                  </Label>
                  <Input
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-2">
              <div className="relative">
                ...
                <Input
                  placeholder={
                    t("admin.pages.testimonials.list.search") ||
                    "Cari testimoni..."
                  }
                  value={searchTerm}
          ...
          <div className="overflow-x-auto">
            <Table>
              <TableHeader>
                <TableRow>
                  <TableHead>
                    {t("admin.pages.testimonials.list.photo") || "Foto"}
                  </TableHead>
                  <TableHead>
                    {t("admin.pages.testimonials.list.client") || "Klien"}
                  </TableHead>
                  <TableHead>
                    {t("admin.pages.testimonials.list.company") || "Perusahaan"}
                  </TableHead>
                  <TableHead>
                    {t("admin.pages.testimonials.list.position") || "Posisi"}
                  </TableHead>
                  <TableHead>
                    {t("admin.pages.testimonials.list.testimonial") ||
                      "Testimoni"}
                  </TableHead>
                  <TableHead>
                    {t("admin.pages.testimonials.list.date") || "Tanggal"}
                  </TableHead>
                  <TableHead className="text-right">
                    {t("admin.pages.testimonials.list.actions") || "Aksi"}
                  </TableHead>
                </TableRow>
              </TableHeader>
              <TableBody>
                    ...
                    <TableCell className="text-right">
                      <div className="flex items-center justify-end space-x-2">
                        ...
                        <Button
                          ...
                          size="sm"
                          onClick={() =>
                            handleDelete(testimonial.id, testimonial.clientName)
                          }
