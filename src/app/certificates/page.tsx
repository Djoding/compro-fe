...
import { Award, Calendar, ExternalLink, Shield, Star, CheckCircle } from "lucide-react";
  ...
  return (
    <div className="pt-20">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
            {companyAchievements.map((achievement, index) => {
              ...
              return (
                <BlurFade key={achievement.title} delay={0.4 + index * 0.1} inView>
      ...
      <section className="py-24 bg-background">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <BlurFade delay={0.2} inView>
            <h2 className="text-3xl font-bold text-foreground mb-12">Certification Statistics</h2>
          </BlurFade>
